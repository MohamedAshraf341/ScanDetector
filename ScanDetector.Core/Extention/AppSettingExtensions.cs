...
namespace ScanDetector.Core.Extention
{
    public static class AppSettingExtensions
    {
        ...
        public static UserSettings ToUserSettings(this AppSetting appSetting)
        {
        ...
        public static List<UserSettings> ToUserSettingsList(this IEnumerable<AppSetting> appSettings)
        {
